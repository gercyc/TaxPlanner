...
namespace TaxPlanner.Server.Migrations
{
    ...
    [Migration("20260608185223_CreatePostsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaxPlanner.Server.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TaxPlanner.Server.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TaxPlanner.Server.Data.ApplicationUser", null)
                        .WithMany()
